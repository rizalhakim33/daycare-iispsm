...
.mobile-menu .mobile-login {
  margin-top: 8px; background: var(--green-dark); color: white;
...
.hero-bg {
  ...
  background: linear-gradient(135deg,rgba(26,58,42,.82) 0%,rgba(45,90,61,.70) 60%,rgba(61,122,82,.55) 100%);
  z-index: 1;
}
.hero-bg-img {
  position: absolute; inset: 0; background: #2d5a3d;
  display: flex; align-items: center; justify-content: center; overflow: hidden;
}
.hero-bg-img::before {
  content: ''; position: absolute; inset: 0;
  background:
    radial-gradient(circle at 20% 50%,rgba(212,168,67,.15) 0%,transparent 50%),
    radial-gradient(circle at 80% 20%,rgba(255,255,255,.05) 0%,transparent 40%);
}
.hero-badge-top {
  position: absolute; top: 40px; left: 50%; transform: translateX(-50%);
  z-index: 3;
  background: rgba(212,168,67,.2); border: 1px solid rgba(212,168,67,.5);
...
.hero-content {
  position: relative; z-index: 2; padding: 64px; max-width: 780px;
}
.hero-title {
...
.hero-desc  { font-size: 17px; color: rgba(255,255,255,.85); max-width: 540px; line-height: 1.7; margin-bottom: 10px }
.hero-vision { font-size: 13px; color: rgba(255,255,255,.55); font-style: italic; margin-bottom: 30px; max-width: 540px }
...
.btn-portal-hero:hover { background: rgba(255,255,255,.2); border-color: rgba(255,255,255,.6) }
.hero-stats {
  display: flex; gap: 0; border-top: 1px solid rgba(255,255,255,.2);
  padding-top: 32px; flex-wrap: wrap;
}
.hero-stat { padding-right: 40px; margin-right: 40px; border-right: 1px solid rgba(255,255,255,.2) }
...
.vision-box .label { font-size: 11px; letter-spacing: 2px; text-transform: uppercase; color: rgba(212,168,67,.8); margin-bottom: 20px }
.vision-box .quote {
  font-family: 'Cormorant Garamond', serif;
...
.prog-card:hover { border-color: var(--green-mid); transform: translateY(-4px); box-shadow: 0 16px 40px rgba(26,58,42,.1) }
.prog-age-badge {
...
.sensori-explainer p { font-size: 15px; color: rgba(255,255,255,.8); line-height: 1.7 }
.sensori-checks { display: grid; grid-template-columns: 1fr 1fr; gap: 12px }
.sensori-check  { display: flex; align-items: center; gap: 10px; font-size: 13px; color: rgba(255,255,255,.85) }
.check-icon {
...
.sensori-num        { font-size: 11px; font-weight: 700; letter-spacing: 1px; opacity: .6; margin-bottom: 4px }
...
/* ── FITRAH KURIKULUM ── */
.fitrah-kurikulum-section { background: #f9f6f0; padding: 96px 64px }
.fitrah-cards-grid {
...
.fitrah-card:hover { transform: translateY(-4px); box-shadow: 0 12px 32px rgba(26,58,42,.10) }
...
.fitrah-quote-bar p    { font-family: 'Cormorant Garamond', serif; font-size: 18px; font-style: italic; font-weight: 400; margin-bottom: 10px; color: rgba(255,255,255,.95) }
.fitrah-quote-bar span { font-size: 12px; color: rgba(255,255,255,.6); letter-spacing: .3px }
...
.fac-img-placeholder p { font-size: 13px; color: rgba(255,255,255,.4); margin-top: 8px }
.halal-badge {
...
.gallery-grid {
  ...
  grid-template-rows: repeat(2,180px); gap: 12px; margin-top: 0;
}
.gallery-item {
...
.info-icon {
  ...
  background: rgba(212,168,67,.2); border: 1px solid rgba(212,168,67,.3);
  display: flex; align-items: center; justify-content: center;
...
.portal-cta-text h2 { font-family: 'Cormorant Garamond', serif; font-size: 36px; font-weight: 700; color: white; margin-bottom: 10px }
.portal-cta-text p  { font-size: 15px; color: rgba(255,255,255,.65); max-width: 560px; line-height: 1.7 }
...
/* ── FOOTER ── */
footer {
  background: var(--green-dark); padding: 32px 64px;
  display: flex; align-items: center; justify-content: space-between;
  flex-wrap: wrap; gap: 16px;
}
footer .f-brand { font-family: 'Cormorant Garamond', serif; font-size: 18px; font-weight: 700; color: white }
footer .f-sub   { font-size: 12px; color: rgba(255,255,255,.5); margin-top: 2px }
footer .f-copy  { font-size: 12px; color: rgba(255,255,255,.45); text-align: right }
...
/* ═══════════════════════════════
   RESPONSIVE — urutan dari besar ke kecil
   ═══════════════════════════════ */
...
@media (max-width: 768px) {
  ...
  .hero-badge-top { font-size: 10px; padding: 6px 14px; top: 24px; letter-spacing: .5px }
  ...
  .btn-gold-solid,
  .btn-outline-white,
  .btn-portal-hero { padding: 12px 20px; font-size: 14px }
...
@media (max-width: 480px) {
  ...
  .hero-stats { flex-direction: column; gap: 16px; border-top: 1px solid rgba(255,255,255,.2); padding-top: 20px }
  .hero-stat { border-right: none; padding-right: 0; margin-right: 0; border-bottom: 1px solid rgba(255,255,255,.1); padding-bottom: 12px }
